...
```
Ex: (2x^2 + 10a - 5) - (x^2 + 3a - 1) = x^2 + 7a - 4
```
...
```
Ex: 2a . (5a + 2x - 1) = 2a . 5a + 2a . 2x - 2a . (-1) = 14a^2 + 4ax - 2a  
Ex: (2 + x) . (5a + 2x - 1) = 2 . 5a + 2 . 2x + 2 . (-1) + x . 5a + x . 2x + x . (-1) = 10a + 4x - 2 + 5ax + 2x^2 - x = 2x^2 + 5ax + 3x + 10a - 2  
```
...
```
Ex: 10a^2 + 20a : 5a = 10a^3/5a + 20a/5a = 2a^2 + 4a
```
