...
- A lógica não se interessa primariamente pelo conteúdo específico das proposições (se falam de Sócrates, metais ou seres fictícios), mas sim pela forma ou estrutura do argumento.
- Forma simbólica:
  - **P1, P2, ... Pn ⊢ Q**
  - Leituras possíveis:
...
- Exemplo:
  - Premissa 1: O índice de aprovação do Gran Cursos é disparado, sendo o melhor.
  - Premissa 2: No Gran Cursos encontram-se professores especialistas em concursos públicos.
...
- É possível um argumento ser válido sem que a conclusão seja necessariamente verdadeira.
- Insofismável = verdade

> ### 2.1 Teste de Validade
- Para verificar a validade, devemos fazer uma suposição:
  - Supor que todas as premissas são verdadeiras (mesmo que, na realidade, não sejam).
  - Perguntar: Com base nessa suposição, a conclusão poderia ser falsa?
  - Se a resposta for NÃO (a conclusão não pode ser falsa), o argumento é VÁLIDO.
  - Se a resposta for SIM (é possível a conclusão ser falsa mesmo com premissas verdadeiras), o argumento é Inválido.

> [!CAUTION] OBSERVAÇÃO:
> - A validade é uma propriedade da estrutura, não do conteúdo. Um argumento pode ser válido mesmo com premissas e conclusão absurdas ou falsas no mundo real.
> - Exemplo de argumento válido com conclusão falsa: 
>   - Todos os mamíferos voam. 
>   - Os homens são mamíferos. 
>   - Logo, os homens voam.
> 
> 1. A estrutura é válida (se os mamíferos voassem, os homens voariam), mas a premissa inicial é falsa .

> ### 2.2 Forma Simbólica Implicativa
- A implicação será falsa apenas quando todas as premissas forem verdadeiras e a conclusão for falsa (V → F = F). Nos demais casos, a implicação é verdadeira.
- Representação:
  - [ P1 ∧ P2 ∧ ... Pn] ⟶ Q

> ### 2.3 Diferença entre Validade e Verdade
- Conceitos Distintos: É fundamental não confundir a validade do argumento (uma característica da relação entre premissas e conclusão) com a verdade das proposições (uma característica de cada enunciado individualmente) .
- Proposições (Premissas e Conclusão): Toda proposição tem um valor de verdade: é verdadeira (V) ou falsa (F) .
- Argumento (como um todo): O argumento não é verdadeiro ou falso, mas sim válido ou inválido (também chamado de correto ou incorreto) 

| PREMISSAS   | CONCLUSÃO  | ARGUMENTO       | ANÁLISE                                                                                                    |
|-------------|------------|-----------------|------------------------------------------------------------------------------------------------------------|
| Verdadeiras | Verdadeira | Válido          | Argumento ideal, perfeito.                                                                                 |
| Verdadeiras | Falsa      | Inválido        | Estrutura falha, pois a verdade das premissas não garantiu a conclusão.                                    |
...
4. Testar a validade: Utilizar tabelas-verdade ou regras de inferência para verificar se é possível que as premissas sejam verdadeiras e a conclusão falsa ao mesmo tempo. Se for impossível, o argumento é válido .

#### Argumento 1 (válido)
- P1: Todos os homens são mortais.
- P2: Sócrates é homem.
- Conclusão: Sócrates é mortal.
- Considerando as premissas verdadeiras, o encadeamento lógico conduz necessariamente à conclusão.

#### Argumento 2 (inválido – falácia)
- P1: Algum cronópio é guilherdo.
- P2: João é cronópio.
- Conclusão: João é guilherdo.
- A conclusão não é sustentada pelas premissas. "Algum" não garante a totalidade; João pode ser o cronópio que não é guilherdo.
