...
## 2. Negação da conjunção (1ª Lei de Morgan)
...
## 3. Negação da Disjunção (2ª Lei de Morgan)
...
## 4. Negação da Condicional (Regra do Mané)
...
#### 5.2 Outras formas de negar a Bicondicional
...
#### 6.2 Outras formar de negação a Disjunção Exclusiva
