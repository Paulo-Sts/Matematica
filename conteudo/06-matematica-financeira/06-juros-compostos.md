...
> [!CAUTION] OBSERVAÇÃO: No regime de juros compostos, as taxas de juros não podem ser convertidas diretamente, como no caso dos juros simples. É necessário encontrar a taxa equivalente por meio da fórmula, dessa forma é preferível alterar o tempo do que a taxa.

> [!TIP] DICA: O Fator é representado por 1 + i e pode estar elevado a uma potência, sendo "i" a taxa (fator = (1 + i)^2). Para facilitar encontrar o valor do fator, pode-se tomar como referência as potências até 20^2. Basta tirar a vírgula na ao calcular a potência para achar o valor do fator.
